...
class acf_field_user_taxonomy extends acf_field {
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-user_taxonomy', "{$dir}js/input.js" );
		wp_enqueue_script('acf-input-user_taxonomy');
		
		
		// register & include CSS
		wp_register_style( 'acf-input-user_taxonomy', "{$dir}css/input.css" ); 
		wp_enqueue_style('acf-input-user_taxonomy');
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-user-taxonomy'),
		}
